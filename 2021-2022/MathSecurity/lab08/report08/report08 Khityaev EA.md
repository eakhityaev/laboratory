...
![Пример работы алгоритмов](image/Screenshot_1.png){ #fig:001 width=70% height=70%}

# Выводы

В ходе выполнения лабораторной работы мне удалось изучить алгоритмы целочисленной арифметики, а также реализовать их программно на языке Python.
