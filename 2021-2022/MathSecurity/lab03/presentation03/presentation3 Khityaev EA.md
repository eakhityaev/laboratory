...
## Front matter
lang: ru-RU
title: Презентация по лабораторной работе №3. Шифр гаммирования
...
![Шифрование](image1/lab_3.1.png){ #fig:001 }

## Алгоритм

![Дешифровка](image1/lab_3.2.png){ #fig:002 }
...
![Работа алгоритма гаммирования](image1/lab_3.3.png){ #fig:003 }

## Пример работы программы

![Пример работы алгоритма гаммирования](image1/lab_3.4.png){ #fig:004 }
